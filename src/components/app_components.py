...
def render_player_search(data_provider, filtered_data=None):
    ...
    use_date_filter = st.checkbox("Enable Date Filter", value=False, help="Filter matches by date range", key="app_date_filter")
    ...
    if use_date_filter:
        ...
        if start_date and end_date:
            ...
            # Debug information
            if st.checkbox("🔍 Show Date Filter Debug Info", value=False, key="app_debug"):
